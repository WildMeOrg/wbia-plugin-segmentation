...
def parse_version(fpath='wbia_segmentation/__init__.py'):
    """
...
URL = 'https://github.com/WildMeOrg/wbia-plugin-segmentation'
LICENSE = 'Apache Version 2.0'
DESCRIPTION = 'wbia_segmentation - Semantic segmentation training and prediction code'
...
KWARGS = OrderedDict(
    ...
    use_scm_version={
        'write_to': 'wbia_segmentation/_version.py',
        'write_to_template': '__version__ = "{version}"',
        'tag_regex': '^(?P<prefix>v)?(?P<version>[^\\+]+)(?P<suffix>.*)?$',
        'local_scheme': 'dirty-tag',
    },
    packages=find_packages(),
    package_dir={'wbia_segmentation': 'wbia_segmentation'},
    ...
    classifiers=[
        ...
        'Operating System :: MacOS :: MacOS Ventura',
